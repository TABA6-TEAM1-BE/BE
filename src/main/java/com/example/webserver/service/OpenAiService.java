...
import com.example.webserver.dto.OpenAiRequestDto;
import com.example.webserver.dto.OpenAiResponseDto;
import com.example.webserver.entity.OpenAiResponseDocument;
import com.example.webserver.repository.OpenAiResponseRepository;
...
public class OpenAiService {
    ...
    private void saveResponseToDatabase(String prompt, String response) {
        OpenAiResponseDocument document = new OpenAiResponseDocument();
